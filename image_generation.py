...
import os
# No longer need dotenv for Vertex AI ADC, as it relies on gcloud authentication
# from dotenv import load_dotenv
from PIL import Image
from google import genai
from google.genai import types

# Removed load_dotenv() as API key is not used directly in code for Vertex AI
